        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Text("Forgor Password",style: TextStyle(color: Colors.grey),)
              ],
            ),
            _user == null ?CircularProgressIndicator():Text("user is ${name} craeted at successfully ${date}"),
            SizedBox(height: 10,),
            Container(
              height: 50,
              ...
              child: InkWell(
                onTap: () async{
                  ...
                  child: Center
                    (child:
                  Text("Created User",style: TextStyle(color: Colors.white,fontSize: 24.0),))),
            )
          ],
        ),
      ),
