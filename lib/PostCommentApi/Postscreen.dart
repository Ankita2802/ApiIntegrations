                        ...
                        children: [
                          InkWell(
                            onTap: (){
                              ...
                              print(id);
                              Navigator.push(context, MaterialPageRoute(builder: (context)=> CommentScreen(id: post[index].id.toString(),)));
                            },
                            child: Container(
                                height: 50,
                                width: 50,
                          ...
                          SizedBox(width: 10,),
                          Expanded(child: Text(post[index].title.toString(),style:GoogleFonts.robotoSlab(color: Colors.black,fontSize: 18.0,fontWeight: FontWeight.bold),maxLines: 2,))
                        ],
                      ),
                    ),
                    Container(
                      child: Row(
                        children: [
                          ...
                          InkWell(
                              ...
                              child:Icon(_ishow ? Icons.comment:Icons.comment,size: 20.0,)
                          ),
                          SizedBox(width: 30,),
                          Expanded(child: Text(post[index].body.toString(),style: GoogleFonts.rocknRollOne(color: Colors.grey,fontSize: 18.0),maxLines: 3,))
                        ],
                      ),
                    ),
                    Visibility(
                      ...
                      child: ListView.builder(
                        ...
                        Row(
                          children: [
                            id2=Text(post1[index].id.toString(),style: TextStyle(fontSize: 20.0),overflow: TextOverflow.ellipsis,),
                            SizedBox(width: 10),
                            Expanded(
                                child: Text(post1[index].body.toString(),style: TextStyle(fontSize: 15.0),maxLines: 4,))
